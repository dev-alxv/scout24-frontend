...
import { PaymentAgbsDialogComponent } from './payment-agbs-dialog.component';
...
describe('PaymentAgbsDialogComponent', () => {
  let comp: PaymentAgbsDialogComponent;
  let fixture: ComponentFixture<PaymentAgbsDialogComponent>;
    ...
    TestBed.configureTestingModule({
      declarations: [
        ...
        MockComponent({
          ...
          inputs: ['loading', 'backgroundColor']
        }),
      ],
      imports: [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PaymentAgbsDialogComponent);
